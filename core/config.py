...
class ConfigManager:
    ...
    public_keys = {
        # activity
        "twitch_url": "https://www.twitch.tv/mkgamerstreams/",
        # bot settings
        "main_category_id": None,
        "fallback_category_id": None,
        "prefix": "?",
        "mention": "@Moderator",
        "main_color": str(discord.Color.pink()),
        ...
        "thread_creation_response": "Thank you for contacting the MainFrame Support Team. We value your report, please give us some time to evaluate your report and we will get back to you as soon as possible.",
        "thread_creation_footer": "Your MainFrame Ticket has been delivered.",
        "thread_contact_silently": False,
        "thread_self_closable_creation_footer": "Click the lock to close the thread",
        "thread_creation_contact_title": "New Ticket",
        "thread_creation_self_contact_response": "You have opened a MainFrame Support Ticket.",
        "thread_creation_contact_response": "{creator.name} has opened a MainFrame Support Ticket.",
        "thread_creation_title": "Thread Created",
        "thread_close_footer": "Replying will create a new ticket",
        "thread_close_title": "Thread Closed",
        "thread_close_response": "MainFrame Staff has closed this ticket. See you in the city!",
        "thread_self_close_response": "MainFrame Staff has closed this ticket. See you in the city!",
        "thread_move_title": "Ticket Moved",
        "thread_move_notify": True,
        "thread_move_notify_mods": False,
        "thread_move_response": "This thread has been moved to its proper category. Hang tight while we sort your ticket out!",
        ...
        "close_on_leave_reason": "The has taken a flight out of MainFrame RP like a bitch.",
        ...
        "private_added_to_group_response": "MainFrame Staff has added you to the support ticket.",
        "private_added_to_group_description_anon": "MainFrame Staff has added you to the support ticket.",
        "public_added_to_group_title": "New User",
        "public_added_to_group_response": "MainFrame Staff has added {users} to the MainFrame Support ticket.",
        "public_added_to_group_description_anon": "A moderator has added {users} to the MainFrame Support ticket.",
        "private_removed_from_group_title": "Removed From Thread (Group)",
        "private_removed_from_group_response": "Mainframe Staff has removed you from the MainFrame Support ticket.",
        ...
        "public_removed_from_group_response": "MainFrame Support ticket has removed {users} from the MainFrame Support ticket.",
        "public_removed_from_group_description_anon": "MainFrame Support ticket has removed {users} from the MainFrame Support ticket.",
        # moderation
        "recipient_color": str(discord.Color.pink()),
        "mod_color": str(discord.Color.purple()),
        "mod_tag": None,
        # anonymous message
        "anon_username": 'MainFrame Support',
        "anon_avatar_url": None,
        "anon_tag": "Staff Response",
        # react to contact
